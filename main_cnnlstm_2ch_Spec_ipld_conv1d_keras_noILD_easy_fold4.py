...
#model1.add(TimeDistributed(Convolution2D(24, 3, 1)))
#model1.add(Activation('relu'))
#model1.add(TimeDistributed(MaxPooling2D(pool_size=pool_size)))
...
dump_fd=cfg.scrap_fd+'/Md/cnn_keras_overlap50_noILD_1CNN128onSpec_fold4_weights.{epoch:02d}-{val_loss:.2f}.hdf5'
