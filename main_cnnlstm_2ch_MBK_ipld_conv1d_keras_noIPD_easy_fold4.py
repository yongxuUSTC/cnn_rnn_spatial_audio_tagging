...
np.random.seed(1515)
import os
import config_2ch_raw_mbk_ipld as cfg
...
model1 = Sequential()
model1.add(TimeDistributed(Convolution2D(128, 30, 1, border_mode='valid', bias=True, W_regularizer=l1l2(l1=0,l2=0)),input_shape=(t_delay,1,feadim, 1)))
...
dump_fd=cfg.scrap_fd+'/Md/cnn_keras_overlap50_fold4_1CNN128onMBK40_noILD_weights.{epoch:02d}-{val_loss:.2f}.hdf5'
...
model1.fit(tr_X1, tr_y, batch_size=100, nb_epoch=21,
