...
tr_X2, te_X2 = reshapeX3(tr_X2), reshapeX3(te_X2)
...
#model1.add(TimeDistributed(Convolution2D(128, 4, 1)))
#model1.add(Activation('relu'))
#model1.add(TimeDistributed(MaxPooling2D(pool_size=pool_size)))
...
model2= Sequential()
model2= Sequential()
model2.add(TimeDistributed(Convolution2D(128, 200, 1, border_mode='valid', bias=True, W_regularizer=l1l2(l1=0,l2=0)),input_shape=(t_delay,1,257, 1)))
model2.add(Activation('relu'))
model2.add(TimeDistributed(MaxPooling2D(pool_size=(257-200+1,1))))
...
dump_fd=cfg.scrap_fd+'/Md/cnn_keras_overlap50_cnn128onRAW_fold4_CNN128onILD257_fold1_weights.{epoch:02d}-{val_loss:.2f}.hdf5'
